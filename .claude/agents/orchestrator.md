...
- **Build**: SPM at `PluginUpdater/` — xcodegen + xcodebuild
...
1. `cd PluginUpdater && xcodebuild -project Pluginventory.xcodeproj -scheme Pluginventory -destination 'platform=macOS' build` — must succeed
